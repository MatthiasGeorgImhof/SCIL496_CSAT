#ifndef __OV2640_INITIALIZATION_HPP__
#define __OV2640_INITIALIZATION_HPP_

#include <cstdint>
#include "OVXXXX_Common.hpp"

// https://github.com/STMicroelectronics/stm32-ov2640/blob/main/ov2640.c

/* Initialization sequence for 480x272 resolution */
static constexpr Word_Byte_t OV2640_480x272[] =
{
...
static constexpr Word_Byte_t OV2640_VGA[] =
{
  {0xff, 0x00},  /* Device control register list Table 12 */
  {0x2c, 0xff},  /* Reserved                              */
  {0x2e, 0xdf},  /* Reserved                              */
...
static constexpr Word_Byte_t OV2640_QVGA[] =
{
  {0xff, 0x00},
  {0x2c, 0xff},
  {0x2e, 0xdf},
...
static constexpr Word_Byte_t OV2640_QQVGA[] =
{
  {0xff, 0x00},
  {0x2c, 0xff},
  {0x2e, 0xdf},
  {0xff, 0x01},
  {0x3c, 0x32},
//   {0x11, 0x00}, /* Set clock prescaler to 1/1 for QQVGA */
//   {0x11, 0x17},  /* Set clock prescaler to 1/24 for QQVGA */
  {0x11, 0x2f},  /* Set clock prescaler to 1/48 for QQVGA */
  {0x09, 0x02},
  {0x04, 0xA8},
  {0x13, 0xe5},
  {0x14, 0x48},
...
#endif // __OV2640_INITIALIZATION_HPP__
