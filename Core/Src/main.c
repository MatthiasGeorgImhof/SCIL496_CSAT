...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, SPI1_CS_MRAM_Pin|SPI1_CS_FLASH2_Pin|SPI1_CS_FLASH1_Pin|CAN2_STB_Pin
                          |CAN2_SHTD_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, CAN1_STB_Pin|CAN1_SHTD_Pin|LED2_Pin|ENABLE_C_Pin
                          |LED4_Pin|ENABLE_A_Pin|ENABLE_B_Pin|CAMERA_STROBE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED5_Pin|LED3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI1_CS_MRAM_Pin SPI1_CS_FLASH2_Pin SPI1_CS_FLASH1_Pin CAN2_STB_Pin
                           CAN2_SHTD_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_MRAM_Pin|SPI1_CS_FLASH2_Pin|SPI1_CS_FLASH1_Pin|CAN2_STB_Pin
                          |CAN2_SHTD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : CAN1_STB_Pin CAN1_SHTD_Pin LED2_Pin ENABLE_C_Pin
                           LED4_Pin ENABLE_A_Pin ENABLE_B_Pin CAMERA_STROBE_Pin */
  GPIO_InitStruct.Pin = CAN1_STB_Pin|CAN1_SHTD_Pin|LED2_Pin|ENABLE_C_Pin
                          |LED4_Pin|ENABLE_A_Pin|ENABLE_B_Pin|CAMERA_STROBE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LED5_Pin LED3_Pin */
  GPIO_InitStruct.Pin = LED5_Pin|LED3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
