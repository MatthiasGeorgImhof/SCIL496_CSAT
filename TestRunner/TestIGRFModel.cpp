...
auto compareMagneticFields = [](const igrf_model::MagneticField& a, const igrf_model::MagneticField& b) {
...
TEST_CASE("Magnetic Field Calculation equatorial sealevel cases") {
    ...
    SUBCASE("Equator, 0 at Surface, 2025") {
        ...
        MagneticField result = calculateMagneticField<MAX_ORDER>(latitude_deg, longitude_deg, radius_m, 2025, igrfCoefficients);
